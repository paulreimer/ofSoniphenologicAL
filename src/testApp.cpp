...
//	cvGrabber.listDevices();
	...
	soundEngine.instruments[1*2] = "wav/marimba";
	...
	soundEngine.instruments[7*2] = "wav/tuba";
...
//	bg.draw(0,0, ofGetWidth(), ofGetHeight());
	...
	float xpos = 1;
#ifdef USE_GUI
	xpos += defaultSimpleGuiConfig.gridSize.x + defaultSimpleGuiConfig.offset.x - defaultSimpleGuiConfig.padding.x;
#endif
...
testApp::keyPressed(int key)
{
	...
	{
		case '1':
			cvGrabber.videoSettings();
			break;
		case '2':
			cameraGrabber.videoSettings();
			break;
	}
}
